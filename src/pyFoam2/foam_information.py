...
from pyFoam2.error import error,warning

from pyFoam2 import configuration as config
...
def getPublicKey():
    from pyFoam2.infrastructure.authentication import myPublicKeyText,ensureKeyPair
    ensureKeyPair()
    return myPublicKeyText()

def getAuthenticatedKeys():
    from pyFoam2.infrastructure.authentication import authenticatedKeys,ensureKeyPair
    ensureKeyPair()
